        ...
        <footer className="w-full bg-gradient-to-br from-[#001428b3] to-[#002850b3] border-t border-[#70a8ff66] mt-24 relative z-10 overflow-visible">
            ...
            <div className="absolute bottom-0 left-0 z-30 pointer-events-none">
                <div className="w-[180px] h-[180px] sm:w-[220px] sm:h-[220px] md:w-[280px] md:h-[280px] lg:w-[340px] lg:h-[340px] drop-shadow-[0_-5px_15px_rgba(0,0,0,0.3)]">
                    <img
                        src={getFileUrl('banca/subprojetos.png')}
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 pl-[130px] sm:pl-[160px] md:pl-[240px] lg:pl-[320px] pr-4 py-3 md:py-5">
                ...
                <div className="flex gap-3 md:gap-5 items-center flex-wrap justify-center md:justify-start">
                    <img src={getFileUrl('banca/usp.png')} alt="Logo USP" className="h-7 md:h-10 lg:h-11 w-auto opacity-90 hover:opacity-100 transition-all filter drop-shadow-md" />
                    <img src={getFileUrl('banca/eachusp.png')} alt="Logo EACH-USP" className="h-7 md:h-10 lg:h-11 w-auto opacity-90 hover:opacity-100 transition-all filter drop-shadow-md" />
                    <img src={getFileUrl('banca/capes.png')} alt="Logo CAPES" className="h-7 md:h-10 lg:h-11 w-auto opacity-90 hover:opacity-100 transition-all filter drop-shadow-md" />
                    <img src={getFileUrl('banca/fapesp.png')} alt="Logo FAPESP" className="h-[12px] md:h-[18px] lg:h-[20px] w-auto opacity-90 hover:opacity-100 transition-all filter drop-shadow-md" />
                </div>
                ...
                <div className="flex flex-col items-center md:items-end text-white text-center md:text-right w-full md:w-auto">
                    ...
                    <div className="flex flex-col gap-1.5 items-center md:items-end">
                        <div className="flex items-center gap-2 bg-white/5 p-1 md:p-2 rounded-lg hover:bg-white/15 transition-all w-fit">
                            <img src={getFileUrl('banca/email.png')} alt="Email" className="w-3 h-3 md:w-5 md:h-5" />
                        ...
                        <div className="flex gap-2 justify-center md:justify-end">
                            <a href="https://instagram.com/bancadaciencia" target="_blank" rel="noreferrer" className="flex items-center gap-2 bg-white/5 p-1 md:p-2 rounded-lg hover:bg-white/15 transition-all">
                                <img src={getFileUrl('banca/instagram.png')} alt="Instagram" className="w-3 h-3 md:w-5 md:h-5" />
                            ...
                            <a href="https://instagram.com/bancadacienciaeach" target="_blank" rel="noreferrer" className="flex items-center gap-2 bg-white/5 p-1 md:p-2 rounded-lg hover:bg-white/15 transition-all">
                                <img src={getFileUrl('banca/instagram.png')} alt="Instagram EACH" className="w-3 h-3 md:w-5 md:h-5" />
